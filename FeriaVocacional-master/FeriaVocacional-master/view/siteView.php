    ...
    <div class="content-wrap">
        ...
        <div class="container clearfix">
            ...
            <div class="col_one_third">
                <div class="feature-box fbox-plain">
                    <div class="fbox-icon" data-animate="bounceIn">
                        <a href="#"><img src="public/images/icons/wifi.png" alt="Responsive Layout"></a>
                    </div>
                    <h3>Conectividad y seguridad</h3>
                    <p>Descripcion</p>
                </div>
            </div>
            ...
            <div class="col_one_third">
                <div class="feature-box fbox-plain">
                    <div class="fbox-icon" data-animate="bounceIn" data-delay="200">
                        <a href="#"><img src="public/images/icons/lan-network.png" alt="Retina Graphics"></a>
                    </div>
        ...
        <div class="container clearfix">
            ...
            <div class="col_one_third">
                <div class="feature-box fbox-plain">
                    ...
                    <h3>Programaci&oacute;n en Java</h3>
                    <p>Descripcion</p>
                </div>
            </div>
            ...
            <div class="col_one_third">
                <div class="feature-box fbox-plain">
                    ...
                    <h3>Programaci&oacute;n Android e IOS</h3>
                    <p>Descripcion</p>
                </div>
            </div>
            ...
            <div class="col_one_third col_last">
                <div class="feature-box fbox-plain">
                    ...
                    <h3>Programaci&oacute;n orientada a objetos</h3>
                    <p>Descripcion.</p>
                </div>
            </div>
        ...
        <div class="container clearfix">
            ...
            <div id="section-base" class="heading-block title-center page-section">
            ...
            <div class="col_one_third">
                <div class="feature-box fbox-plain">
                    <div class="fbox-icon" data-animate="bounceIn">
                        <a href="#"><img src="public/images/icons/folder.png" alt="Responsive Layout"></a>
                    </div>
            ...
            <div class="col_one_third">
                <div class="feature-box fbox-plain">
                    <div class="fbox-icon" data-animate="bounceIn" data-delay="200">
                        <a href="#"><img src="public/images/icons/database-interconnected.png" alt="Retina Graphics"></a>
                    </div>
            ...
            <div class="col_one_third col_last">
                <div class="feature-box fbox-plain">
                    <div class="fbox-icon" data-animate="bounceIn" data-delay="400">
                        <a href="#"><img src="public/images/icons/database.png" alt="Powerful Performance"></a>
                    </div>
                    <h3>Modelado de bases de datos</h3>
                    <p>Descripcion</p>
                </div>
            </div>
         ...
         <div class="container clearfix">
            ...
            <div id="section-robo" class="heading-block title-center page-section">
                <h2>Rob&oacute;tica</h2>
                <span>Hola soy descripcion</span>
            </div>
